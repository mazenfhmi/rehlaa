...
void main() {
  group('CheckoutViewModel', () {
    ...
    test('initial state loads payment methods and calculates quote', () async {
      final subtotal = const Money.sdg(1000000);
    ...
    test('can submit bank transfer after all fields provided', () async {
      ...
      vm.selectPaymentMethod('bank_transfer');
      await vm.selectBank('bok');
      vm.setOperationNumber('123456');
      vm.setReceipt(const PickedFile(path: 'test', name: 'test.jpg', mimeType: 'image/jpeg', sizeBytes: 100));
