...
mixin _$Category {
  ...
  @override
  String toString() {
    return 'Category(id: $id, nameAr: $nameAr, nameEn: $nameEn, imageUrl: $imageUrl)';
  }
}
...
abstract mixin class $CategoryCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String nameAr, String nameEn, String imageUrl});
}
...
extension CategoryPatterns on Category {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String nameAr, String nameEn, String imageUrl)?
    $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Category() when $default != null:
        return $default(_that.id, _that.nameAr, _that.nameEn, _that.imageUrl);
      case _:
        return orElse();
    }
  }
