...
abstract mixin class $CartCopyWith<$Res> {
  factory $CartCopyWith(Cart value, $Res Function(Cart) _then) =
      _$CartCopyWithImpl;
  @useResult
  $Res call({List<CartItem> items, Money subtotal});
}
...
class _$CartCopyWithImpl<$Res> implements $CartCopyWith<$Res> {
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? items = null, Object? subtotal = null}) {
    return _then(
      _self.copyWith(
        items: null == items
            ? _self.items
...
extension CartPatterns on Cart {
  ...
  @optionalTypeArgs
  TResult map<TResult extends Object?>(TResult Function(_Cart value) $default) {
    final _that = this;
    switch (_that) {
      case _Cart():
        return $default(_that);
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<CartItem> items, Money subtotal)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Cart() when $default != null:
        return $default(_that.items, _that.subtotal);
      case _:
        return orElse();
    }
  }
...
class _Cart implements Cart {
  const _Cart({required final List<CartItem> items, required this.subtotal})
    : _items = items;
