...
class SecondaryProductCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final double? effectivePriceAfterDiscount = priceAfterDiscount ?? priceAfetDiscount;
    final int? effectiveDiscountPercent = discountPercent ?? dicountpercent;
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Spacer(),
                  effectivePriceAfterDiscount != null
                      ? Row(
                          children: [
                            Text(
